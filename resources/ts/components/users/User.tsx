        ...
        <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            <div id="profile"
                ...
                <div className="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <p className="pt-8 text-sm">{user.introduction}</p>
                    ...
                    <div
                        ...
                        <a className="link" href={user.github} data-tippy-content="@github_handle" target="_blank">
            ...
            <div className="w-full lg:w-2/5">
                <img src={user.image} className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block img-height"/>
            </div>
